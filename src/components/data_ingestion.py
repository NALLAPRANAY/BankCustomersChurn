...
if __name__=="__main__":
    ...
    train_arr,test_arr,preprocessor_file=data_transformation.intiate_data_transformation(train_path=train_path,test_path=test_path)
    model=ModelTraining()
    acs=model.intiate_modeltraining(train_arr,test_arr)
    print(acs)
